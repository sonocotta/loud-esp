...
#include <I2S.h>
const int frequency = 10;  // frequency of square wave in Hz
const int amplitudeBits = 14;
const int amplitude = 1 << amplitudeBits;   // amplitude of square wave
...
#ifndef I2S_MODE
#define I2S_MODE I2S_PHILIPS_MODE
#endif
i2s_mode_t mode = I2S_MODE;   // I2S_PHILIPS_MODE; <- I2S decoder is needed
                              // ADC_DAC_MODE;     <- Audio amplifier is needed
// Mono channel input
